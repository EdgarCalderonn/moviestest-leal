...
class Serie {
    ...
    factory Serie.fromJson(Map<String, dynamic> json) => Serie(
        ...
        createdBy: json["created_by"] == null ? null : List<dynamic>.from(json["created_by"].map((x) => x)),
        ...
        productionCompanies: json["production_companies"] == null ? null : List<dynamic>.from(json["production_companies"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "created_by": createdBy == null ? null : List<dynamic>.from(createdBy!.map((x) => x)),
        ...
        "last_air_date": lastAirDate == null ? null : "${lastAirDate!.year.toString().padLeft(4, '0')}-${lastAirDate!.month.toString().padLeft(2, '0')}-${lastAirDate!.day.toString().padLeft(2, '0')}",
        ...
        "production_companies": productionCompanies == null ? null : List<dynamic>.from(productionCompanies!.map((x) => x)),
